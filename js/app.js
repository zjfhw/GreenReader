...
var RSSReader, currentNavJson, jQT, listNavJson, mainNavJson, pullDownAction, store, subscriptionData;
...
RSSReader.subscriptionController = Em.ArrayController.create({
  ...
  addItem: function(item) {
    ...
    if (exists === 0) {
      ...
      this.pushObject(RSSReader.Subscription.create(itemToAdd));
      return true;
    } else {
      return false;
    }
...
RSSReader.SubscriptionView = Em.CollectionView.extend({
  ...
  itemViewClass: Em.View.extend({
    ...
    getstore: function() {
      ...
      return jQT.goTo('#list-view', 'slideleft');
    },
    "delete": function() {
