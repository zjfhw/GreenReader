...
var currentNavJson, listNavJson, mainNavJson, nimei, pullDownAction, store, subscriptionData;
...
RSSReader.navbarController = Em.ArrayController.create({
  ...
  currentPageTab: function() {
    var btn, _i, _len, _results;
    this.clear();
    _results = [];
    for (_i = 0, _len = currentNavJson.length; _i < _len; _i++) {
      btn = currentNavJson[_i];
      _results.push(this.pushObject(RSSReader.NavButton.create(btn)));
    }
    return _results;
  }
